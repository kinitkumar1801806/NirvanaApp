...
public class ClinicWelcomeActivity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    FirebaseAuth auth;
    public TextView clinic_name,clinic_address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clinic_name=hView.findViewById(R.id.header_name);
        clinic_address=hView.findViewById(R.id.header_address);
    ...
    private void RetrieveClinicDetails() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                clinic_name.setText(name);//clinic uses hospital_details model file
                clinic_address.setText(address);
            }
