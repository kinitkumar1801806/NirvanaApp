...
public class MyDoctorActivity extends AppCompatActivity {
    ...
    private class AsyncTaskRunner extends AsyncTask<String,String,String>
    {
        ...
        protected void onPreExecute() {
            progressDialog =new ProgressDialog(MyDoctorActivity.this);
            progressDialog.show();
        ...
        protected void onPostExecute(String s) {
            ImageAdapter_Doctor adapterViewAndroid = new ImageAdapter_Doctor(MyDoctorActivity.this, ImageArray, NameList,Username_List);
