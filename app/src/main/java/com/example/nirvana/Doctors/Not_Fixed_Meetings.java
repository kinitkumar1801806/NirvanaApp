...
public class Not_Fixed_Meetings extends AppCompatActivity {
 ...
 {
     not_fixed_meeting_adapter = new Not_Fixed_Meeting_Adapter(Not_Fixed_Meetings.this,Image_Array,NameList,Username_List,Expand_List,Problem_List,date1,time);
