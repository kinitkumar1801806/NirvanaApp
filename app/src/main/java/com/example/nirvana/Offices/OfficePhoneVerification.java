...
import com.example.nirvana.Schools.School_details;
...
public class OfficePhoneVerification extends AppCompatActivity {
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks =
            new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                ...
                public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                    ...
                    if (code1 != null) {
                        code=findViewById(R.id.code_office);
                        code.setText(code1);
                        //verifying the code
                ...
                public void onVerificationFailed(FirebaseException e) {
                    Toast.makeText(OfficePhoneVerification.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                }
...
//                super.onCodeSent(s, forceResendingToken);
    ...
    private void verifyVerificationCode(String code) {
        ...
        {
            Toast.makeText(OfficePhoneVerification.this,"Please make sure that sim of entered number is available in your phone",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(OfficePhoneVerification.this,
                        new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    databaseReference= FirebaseDatabase.getInstance().getReference("Offices").child(Contact)
                                            .setValue(school_details).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    progressBar.setVisibility(View.GONE);
                                                    Toast.makeText(OfficePhoneVerification.this,"Successfully signed up",Toast.LENGTH_SHORT).show();
                                                    Intent intent=new Intent(OfficePhoneVerification.this, Patient_Welcome_Activity.class);
                                    ...
                                    Toast.makeText(OfficePhoneVerification.this,message,Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
    }
