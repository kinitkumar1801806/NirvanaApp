...
public class PendingMeetingsStep1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       PendingMeetingsStep1.AsyncTaskRunner asyncTaskRunner=new PendingMeetingsStep1.AsyncTaskRunner();
    ...
    private class AsyncTaskRunner extends AsyncTask<String,String,String>
    {
        ...
        protected void onPreExecute() {
            progressDialog =new ProgressDialog(PendingMeetingsStep1.this);
            progressDialog.show();
        ...
        protected void onPostExecute(String s) {
            Not_Fixed_Meeting_Adapter adapterViewAndroid = new Not_Fixed_Meeting_Adapter(PendingMeetingsStep1.this, NameList,Username_List,date1,time,Image_Array);
